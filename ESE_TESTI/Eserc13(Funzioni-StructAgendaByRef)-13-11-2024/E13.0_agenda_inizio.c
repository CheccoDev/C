...
void stampaData(TdataOra d){
	printf("%02d/%02d/%4d %02d:%02d",d.giorno,d.mese,d.anno,d.ora,d.minuti);
}
...
void stampaEvento(Tevento e){
   printf("Inizio: ");   stampaData(e.inizio);  printf("\n");
   printf("Fine: ");     stampaData(e.fine);    printf("\n");
   stampaAttivita(e.attivita); printf("\n");
}
